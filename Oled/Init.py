...
sleep(8)
draw.rectangle((0, 0, oled.width-1, oled.height-1), outline=1, fill=0)
font = ImageFont.truetype('BodoniItalic.ttf', 38)
draw.rectangle((0, 0, oled.width-1, oled.height-1), outline=255, fill=1)
draw.text((2, 2), 'AMIGA', font=font, fill=0)
font = ImageFont.truetype('bodoni.ttf', 26)
draw.text((15, 10), '________', font=font, fill=0)
draw.text((32, 35), '3000', font=font, fill=0)
oled.display()
